        ...
        @foreach($categories as $category)
            <div class="col-md-2">
                <div class="card mb-4 h-100">
                    <img src="{{ $category->image }}" class="card-img-top h-100 w-100 object-fit-cover" alt="Фото">
                    <div class="card-body border-primary">
                        <h5 class="card-title">{{ $category->title }}</h5>
                        <a href="bulletins?category_id={{$category->id}}" class="stretched-link"></a>
                    </div>
                </div>
            </div>
        @endforeach
        ...
        @foreach($bulletins as $bulletin)
            <div class="col-md-3 mb-4">
                <div class="card h-100">
                    <img src="{{ $bulletin->image }}" class="card-img-top h-100 object-fit-cover" alt="Фото">
                    <div class="card-body">
