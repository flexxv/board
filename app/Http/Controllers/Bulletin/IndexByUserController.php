...
class IndexByUserController extends BaseController
{
    public function __invoke(FilterRequest $request) {
        ...
        $bulletins = Bulletin::filter($filter)->where('user_id', $userId)->paginate(12);
        ...
        return view('userprofile', compact('bulletins'));
    }
}
